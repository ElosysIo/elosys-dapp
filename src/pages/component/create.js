            ...
            <img src="\bg-imgs\banner-bg.svg" alt="img" className='img-fluid banner-bg' />
                <div className="custom-container">
                    <div className="bannerheadings">
                        <h4 className="bannerhead">Create Elosys account</h4>
                        <p className="bannerpara">Elosys Layer’s wallet in browser environment, which supports both same-chain and cross chain auditable confidential assets transfer.</p>
                    </div>
                    <div className="bannerwallet">
                        <div className="mainwallet">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
                                <path d="M25 46.875C37.0812 46.875 46.875 37.0812 46.875 25C46.875 12.9188 37.0812 3.125 25 3.125C12.9188 3.125 3.125 12.9188 3.125 25C3.125 37.0812 12.9188 46.875 25 46.875Z" fill="#61D290" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M14.0811 25.0189L35.9154 24.9846L14.0811 25.0189ZM24.981 14.0845L25.0153 35.9188L24.981 14.0845Z" fill="#002A12" />
                                <path d="M14.0811 25.0189L35.9154 24.9846M24.981 14.0845L25.0153 35.9188" stroke="#002A12" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <h5 className="mainhead">I&apos;m new here!</h5>
                            <p className="mainpara">A new Elosys wallet and a list of mnemonic words will be created for you.</p>
                            <Link href="/createwallet" className="w-100">
                        ...
                        <div className="mainwallet">
                            <svg xmlns="http://www.w3.org/2000/svg" width="51" height="50" viewBox="0 0 51 50" fill="none">
                                <path d="M25.6006 46.9758C37.6818 46.9758 47.4756 37.1821 47.4756 25.1008C47.4756 13.0196 37.6818 3.22583 25.6006 3.22583C13.5194 3.22583 3.72559 13.0196 3.72559 25.1008C3.72559 37.1821 13.5194 46.9758 25.6006 46.9758Z" fill="#61D290" />
                                <path d="M15.8223 33.8709L34.3707 15.3225" stroke="#002A12" stroke-width="4" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M15.8223 19.9597V33.871H29.7336" stroke="#002A12" stroke-width="4" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                            <h5 className="mainhead">Already have one?</h5>
                            <p className="mainpara">Import your existing Elosys wallet using the Secret Recovery Phrase.</p>
                            <Link href="/importwallet" className="w-100">
